...
function useUser(props) {
  ...
  const slots = (0, import_react.useMemo)(() => user(), []);
...
// node_modules/@heroui/avatar/dist/chunk-S5XC7GTZ.mjs
...
function useImage(props = {}) {
  ...
  const imageRef = (0, import_react2.useRef)(isHydrated ? new Image() : null);
...
// node_modules/@heroui/avatar/dist/chunk-WNF7UL5S.mjs
...
var User = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Component, { ...getUserProps(), children: [
    (0, import_jsx_runtime4.jsx)(avatar_default, { ...avatarProps }),
    (0, import_jsx_runtime4.jsxs)("div", { className: slots.wrapper({ class: classNames == null ? void 0 : classNames.wrapper }), children: [
      (0, import_jsx_runtime4.jsx)("span", { className: slots.name({ class: classNames == null ? void 0 : classNames.name }), children: name }),
      (0, import_jsx_runtime4.jsx)("span", { className: slots.description({ class: classNames == null ? void 0 : classNames.description }), children: description })
    ] })
  ] });
});
...
//# sourceMappingURL=@heroui_user.js.map
