...
import {
  button_default
} from "./chunk-MY27ZTZL.js";
import "./chunk-PFDTHZOC.js";
import "./chunk-I6YY6ZWF.js";
import "./chunk-K3VZPS36.js";
import {
...
function $8796f90736e175cb$export$4d40659c25ecb50b(props = {}) {
  ...
  let id = (0, import_react3.useMemo)(() => `${++$8796f90736e175cb$var$tooltipId}`, []);
  let closeTimeout = (0, import_react3.useRef)(null);
  let closeCallback = (0, import_react3.useRef)(close);
...
function $4e1b34546679e357$export$a6da6c504e4bba8b(props, state, ref) {
  ...
  let isHovered = (0, import_react4.useRef)(false);
  let isFocused = (0, import_react4.useRef)(false);
  let handleShow = () => {
...
function useTooltip(originalProps) {
  ...
  const getTooltipContentProps = (0, import_react6.useCallback)(
    () => ({
      "data-slot": "content",
      "data-open": dataAttr(isOpen),
      "data-arrow": dataAttr(showArrow),
...
var Tooltip = forwardRef((props, ref) => {
  ...
  let trigger;
  try {
    const childrenNum = import_react7.Children.count(children);
    ...
    if (!(0, import_react7.isValidElement)(children)) {
      ...
      trigger = (0, import_react7.cloneElement)(child, getTriggerProps(child.props, childRef));
    }
  } catch {
...
var Snippet = forwardRef((props, ref) => {
  ...
  const TooltipContent = (0, import_react8.useCallback)(
  ...
  const contents = (0, import_react8.useMemo)(() => {
    if (hideCopyButton) {
      return null;
    }
    const clonedCheckIcon = checkIcon && (0, import_react8.cloneElement)(checkIcon, { className: slots.checkIcon() });
    const clonedCopyIcon = copyIcon && (0, import_react8.cloneElement)(copyIcon, { className: slots.copyIcon() });
  ...
  const preContent = (0, import_react8.useMemo)(() => {
