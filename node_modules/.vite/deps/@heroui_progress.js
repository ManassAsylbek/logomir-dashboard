...
var CircularProgress = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Component, { ...progressBarProps, children: [
    (0, import_jsx_runtime.jsxs)("div", { className: slots.svgWrapper({ class: classNames == null ? void 0 : classNames.svgWrapper }), children: [
      (0, import_jsx_runtime.jsxs)("svg", { ...getSvgProps(), children: [
        (0, import_jsx_runtime.jsx)("circle", { ...getTrackProps() }),
        (0, import_jsx_runtime.jsx)("circle", { ...getIndicatorProps() })
      ] }),
      showValueLabel && (0, import_jsx_runtime.jsx)("span", { className: slots.value({ class: classNames == null ? void 0 : classNames.value }), children: progressBarProps["aria-valuetext"] })
    ] }),
...
var Progress = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Component, { ...progressBarProps, children: [
    shouldShowLabelWrapper ? (0, import_jsx_runtime2.jsxs)("div", { className: slots.labelWrapper({ class: classNames == null ? void 0 : classNames.labelWrapper }), children: [
      label && (0, import_jsx_runtime2.jsx)("span", { ...getLabelProps(), children: label }),
      showValueLabel && (0, import_jsx_runtime2.jsx)("span", { className: slots.value({ class: classNames == null ? void 0 : classNames.value }), children: progressBarProps["aria-valuetext"] })
    ] }) : null,
    (0, import_jsx_runtime2.jsx)("div", { className: slots.track({ class: classNames == null ? void 0 : classNames.track }), children: (0, import_jsx_runtime2.jsx)(
      "div",
      {
        className: slots.indicator({ class: classNames == null ? void 0 : classNames.indicator }),
        style: {
...
//# sourceMappingURL=@heroui_progress.js.map
