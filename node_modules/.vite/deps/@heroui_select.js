...
import {
  ...
  useIsMobile
} from "./chunk-KNOC5CEW.js";
import {
  free_solo_popover_default
} from "./chunk-GXRMK5SZ.js";
import "./chunk-ITQ5X72A.js";
import {
  ChevronDownIcon,
  CloseFilledIcon
} from "./chunk-FERQPGHA.js";
import {
  $2baaea4c71418dea$export$294aa081a6c6f55d,
  $d191a55c9702f145$export$8467354a121f1b9f
} from "./chunk-C5YOHIMV.js";
import {
  useSafeLayoutEffect
...
import {
  ...
  useLabelPlacement,
  useProviderContext
} from "./chunk-MRB2E7SS.js";
import {
  AnimatePresence
} from "./chunk-SLDUYBX7.js";
import {
...
var useLayoutEffect2 = typeof document !== "undefined" ? import_react144.default.useLayoutEffect : () => {
};
function useEffectEvent(fn) {
  ...
  return (0, import_react144.useCallback)((...args) => {
    const f2 = ref.current;
    return f2 == null ? void 0 : f2(...args);
  }, []);
}
function useFormReset(ref, initialValue, onReset) {
  let resetValue = (0, import_react144.useRef)(initialValue);
...
function $e93e671b31057976$export$b8473d3665f3a75a(props, state, ref) {
  ...
  let isIgnoredReset = (0, import_react145.useRef)(false);
...
function $c1d7fb2ec91bae71$var$hasChildItems2(props) {
  if (props.hasChildItems != null) return props.hasChildItems;
  if (props.childItems) return true;
  if (props.title && (0, import_react146.default).Children.count(props.children) > 0) return true;
  return false;
}
...
var $eb2240fc39a57fa5$export$bf788dd355e3a4012 = class {
  ...
  *iterateCollection(props) {
    let { children, items } = props;
    if ((0, import_react148.default).isValidElement(children) && children.type === (0, import_react148.default).Fragment) yield* this.iterateCollection({
      children: children.props.children,
      items
    });
    else if (typeof children === "function") {
      ...
      let items2 = [];
      (0, import_react148.default).Children.forEach(children, (child) => {
        if (child) items2.push(child);
      });
      let index = 0;
      for (let item of items2) {
  ...
  *getFullNode(partialNode, state, parentKey, parentNode) {
    if ((0, import_react148.default).isValidElement(partialNode.element) && partialNode.element.type === (0, import_react148.default).Fragment) {
      let children = [];
      (0, import_react148.default).Children.forEach(partialNode.element.props.children, (child) => {
        children.push(child);
      });
      var _partialNode_index;
      let index = (_partialNode_index = partialNode.index) !== null && _partialNode_index !== void 0 ? _partialNode_index : 0;
    ...
    if ((0, import_react148.default).isValidElement(element)) {
      let type = element.type;
      if (typeof type !== "function" && typeof type.getCollectionNode !== "function") {
        let name = element.type;
        throw new Error(`Unknown element <${name}> in collection.`);
...
function $7613b1592d41b092$export$6cd28814d92fa9c92(props, factory, context) {
  let builder = (0, import_react149.useMemo)(() => new (0, $eb2240fc39a57fa5$export$bf788dd355e3a4012)(), []);
  let { children, items, collection } = props;
  let result = (0, import_react149.useMemo)(() => {
    if (collection) return collection;
    let nodes = builder.build({
      children,
      items
...
function $fb3050f43d946246$export$e32c88dfddc6e1d82(options) {
  let { keyboardDelegate, selectionManager, onTypeSelect } = options;
  let state = (0, import_react150.useRef)({
    search: "",
    timeout: void 0
  }).current;
  let onKeyDown = (e) => {
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c2(options) {
  ...
  let scrollPos = (0, import_react151.useRef)({
    top: 0,
    left: 0
  });
  ...
  let shouldVirtualFocusFirst = (0, import_react151.useRef)(false);
  ...
  const autoFocusRef = (0, import_react151.useRef)(autoFocus);
  const didAutoFocusRef = (0, import_react151.useRef)(false);
  ...
  let lastFocusedKey = (0, import_react151.useRef)(manager.focusedKey);
  let raf = (0, import_react151.useRef)(null);
  (0, import_react151.useEffect)(() => {
...
function $880e95eb8b93ba9a$export$ecf600387e221c372(options) {
  ...
  let modality = (0, import_react152.useRef)(null);
  let longPressEnabled = hasAction && allowsSelection;
  let longPressEnabledOnPressStart = (0, import_react152.useRef)(false);
  let hadPrimaryActionOnPressStart = (0, import_react152.useRef)(false);
...
function $982254629710d113$export$b95089534ab7c1fd2(props) {
  ...
  let delegate = (0, import_react153.useMemo)(() => keyboardDelegate || new (0, $2a25aae57d74318e$export$a05409b8bb224a5a2)({
    collection,
    disabledKeys,
    disabledBehavior,
    ref,
...
function $e72dd72e1c76a225$export$2f645645f7bca7642(props) {
  let { filter, layoutDelegate } = props;
  let selectionState = (0, $7af3f5b51489e0b5$export$253fe78d46329472)(props);
  let disabledKeys = (0, import_react154.useMemo)(() => props.disabledKeys ? new Set(props.disabledKeys) : /* @__PURE__ */ new Set(), [
    props.disabledKeys
  ]);
  let factory = (0, import_react154.useCallback)((nodes) => filter ? new (0, $a02d57049d202695$export$d085fb9e920b5ca72)(filter(nodes)) : new (0, $a02d57049d202695$export$d085fb9e920b5ca72)(nodes), [
    filter
  ]);
  let context = (0, import_react154.useMemo)(() => ({
    suppressTextValueWarning: props.suppressTextValueWarning
  }), [
    props.suppressTextValueWarning
  ]);
  let collection = (0, $7613b1592d41b092$export$6cd28814d92fa9c92)(props, factory, context);
  let selectionManager = (0, import_react154.useMemo)(() => new (0, $d496c0a20b6e58ec$export$6c8a5aaad13c9852)(collection, selectionState, {
    layoutDelegate
  }), [
    collection,
    selectionState,
...
function $e72dd72e1c76a225$var$useFocusedKeyReset2(collection, selectionManager) {
  const cachedCollection = (0, import_react154.useRef)(null);
...
function useListbox(props) {
  ...
  const slots = (0, import_react156.useMemo)(() => menu(), []);
  const baseStyles2 = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useDivider(props) {
  ...
  const styles = (0, import_react159.useMemo)(
    () => divider({
      orientation,
      className
    }),
  ...
  const getDividerProps = (0, import_react159.useCallback)(
    (props2 = {}) => ({
      className: styles,
      role: "separator",
...
var ListboxSection = forwardRef(
  ({
    ...
    const slots = (0, import_react160.useMemo)(() => menuSection(), []);
    const baseStyles2 = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useVirtualizerBase(options) {
  ...
  const resolvedOptions = {
    ...
    onChange: (instance2, sync) => {
      var _a;
      if (sync) {
        (0, import_react_dom11.flushSync)(rerender);
      } else {
        rerender();
      }
...
function useDataScrollOverflow(props = {}) {
  ...
  const visibleRef = (0, import_react162.useRef)(visibility);
...
var VirtualizedListbox = (props) => {
  ...
  const parentRef = (0, import_react161.useRef)(null);
  const itemSizes = (0, import_react161.useMemo)(
  ...
  const [scrollState, setScrollState] = (0, import_react161.useState)({
    isTop: false,
    isBottom: true,
    isMiddle: false
  });
...
function useSpinner(originalProps) {
  ...
  const slots = (0, import_react166.useMemo)(() => spinner({ ...variantProps }), [objectToDeps(variantProps)]);
  const baseStyles2 = clsx(classNames == null ? void 0 : classNames.base, className);
  const label = labelProp || children;
  const ariaLabel = (0, import_react166.useMemo)(() => {
    if (label && typeof label === "string") {
      return label;
    }
    return !otherProps["aria-label"] ? "Loading" : "";
  }, [children, label, otherProps["aria-label"]]);
  const getSpinnerProps = (0, import_react166.useCallback)(
    () => ({
      "aria-label": ariaLabel,
      className: slots.base({
        class: baseStyles2
...
var Spinner = forwardRef3((props, ref) => {
  ...
  if (variant === "wave" || variant === "dots") {
    return (0, import_jsx_runtime12.jsxs)("div", { ref, ...getSpinnerProps(), children: [
      (0, import_jsx_runtime12.jsx)("div", { className: slots.wrapper({ class: classNames == null ? void 0 : classNames.wrapper }), children: [...new Array(3)].map((_, index) => (0, import_jsx_runtime12.jsx)(
        "i",
        {
      ...
      label && (0, import_jsx_runtime12.jsx)("span", { className: slots.label({ class: classNames == null ? void 0 : classNames.label }), children: label })
    ] });
  }
  if (variant === "simple") {
    return (0, import_jsx_runtime12.jsxs)("div", { ref, ...getSpinnerProps(), children: [
  ...
  if (variant === "spinner") {
    return (0, import_jsx_runtime12.jsxs)("div", { ref, ...getSpinnerProps(), children: [
      (0, import_jsx_runtime12.jsx)("div", { className: slots.wrapper({ class: classNames == null ? void 0 : classNames.wrapper }), children: [...new Array(12)].map((_, index) => (0, import_jsx_runtime12.jsx)(
        "i",
        {
  ...
  return (0, import_jsx_runtime12.jsxs)("div", { ref, ...getSpinnerProps(), children: [
    (0, import_jsx_runtime12.jsxs)("div", { className: slots.wrapper({ class: classNames == null ? void 0 : classNames.wrapper }), children: [
      (0, import_jsx_runtime12.jsx)("i", { className: slots.circle1({ class: classNames == null ? void 0 : classNames.circle1 }) }),
      (0, import_jsx_runtime12.jsx)("i", { className: slots.circle2({ class: classNames == null ? void 0 : classNames.circle2 }) })
    ] }),
    label && (0, import_jsx_runtime12.jsx)("span", { className: slots.label({ class: classNames == null ? void 0 : classNames.label }), children: label })
  ] });
});
...
function useDataScrollOverflow2(props = {}) {
  ...
  const visibleRef = (0, import_react167.useRef)(visibility);
...
function useScrollShadow2(originalProps) {
  ...
  const styles = (0, import_react168.useMemo)(
    () => scrollShadow({
      ...variantProps,
      className
    }),
...
var ScrollShadow = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime13.jsx)(Component, { ...getBaseProps(), children });
});
...
var Select = forwardRef(function Select2(props, ref) {
  ...
  const {
    ...
    isLoading,
    triggerRef,
    selectorIcon = (0, import_jsx_runtime14.jsx)(ChevronDownIcon, {}),
    description,
    errorMessage,
    isInvalid,
    startContent,
  ...
  const labelContent = label ? (0, import_jsx_runtime14.jsx)("label", { ...getLabelProps(), children: label }) : null;
  const clonedIcon = (0, import_react170.cloneElement)(selectorIcon, getSelectorIconProps());
  const clearButton = (0, import_react169.useMemo)(() => {
    var _a2;
    if (isClearable && ((_a2 = state.selectedItems) == null ? void 0 : _a2.length)) {
      return (0, import_jsx_runtime14.jsx)("span", { ...getClearButtonProps(), children: (0, import_jsx_runtime14.jsx)(CloseFilledIcon, {}) });
    }
    return null;
  }, [isClearable, getClearButtonProps, (_a = state.selectedItems) == null ? void 0 : _a.length]);
  const end = (0, import_react169.useMemo)(() => {
    if (clearButton) {
      return (0, import_jsx_runtime14.jsxs)("div", { ...getEndWrapperProps(), children: [
        clearButton,
        endContent && (0, import_jsx_runtime14.jsx)("span", { ...getEndContentProps(), children: endContent })
      ] });
    }
    return endContent && (0, import_jsx_runtime14.jsx)("span", { ...getEndContentProps(), children: endContent });
  ...
  const helperWrapper = (0, import_react169.useMemo)(() => {
    ...
    return (0, import_jsx_runtime14.jsx)("div", { ...getHelperWrapperProps(), children: shouldShowError ? (0, import_jsx_runtime14.jsx)("div", { ...getErrorMessageProps(), children: errorMessage }) : (0, import_jsx_runtime14.jsx)("div", { ...getDescriptionProps(), children: description }) });
  }, [
    hasHelper,
    isInvalid,
    errorMessage,
  ...
  const renderSelectedItem = (0, import_react169.useMemo)(() => {
    var _a2;
  ...
  const renderIndicator = (0, import_react169.useMemo)(() => {
    if (isLoading) {
      return (0, import_jsx_runtime14.jsx)(spinner_default, { ...getSpinnerProps() });
    }
    return clonedIcon;
  }, [isLoading, clonedIcon, getSpinnerProps]);
  const popoverContent = (0, import_react169.useMemo)(
    () => state.isOpen ? (0, import_jsx_runtime14.jsx)(free_solo_popover_default, { ...getPopoverProps(), children: (0, import_jsx_runtime14.jsx)(scroll_shadow_default, { ...getListboxWrapperProps(), children: (0, import_jsx_runtime14.jsx)(listbox_default, { ...getListboxProps() }) }) }) : null,
    [state.isOpen, getPopoverProps, state, triggerRef, getListboxWrapperProps, getListboxProps]
  );
  return (0, import_jsx_runtime14.jsxs)("div", { ...getBaseProps(), children: [
    (0, import_jsx_runtime14.jsx)(HiddenSelect, { ...getHiddenSelectProps() }),
    shouldLabelBeOutside ? labelContent : null,
    (0, import_jsx_runtime14.jsxs)("div", { ...getMainWrapperProps(), children: [
      (0, import_jsx_runtime14.jsxs)(Component, { ...getTriggerProps(), children: [
        !shouldLabelBeOutside ? labelContent : null,
        (0, import_jsx_runtime14.jsxs)("div", { ...getInnerWrapperProps(), children: [
          startContent,
          (0, import_jsx_runtime14.jsx)("span", { ...getValueProps(), children: renderSelectedItem }),
          endContent && state.selectedItems && (0, import_jsx_runtime14.jsx)($5c3e21d68f1c4674$export$439d29a4e110a1642, { elementType: "span", children: "," }),
          end
        ] }),
        renderIndicator
      ] }),
    ...
    disableAnimation ? popoverContent : (0, import_jsx_runtime14.jsx)(AnimatePresence, { children: popoverContent })
  ] });
});
