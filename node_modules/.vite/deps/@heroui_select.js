...
function useSpinner(originalProps) {
  ...
  const slots = (0, import_react165.useMemo)(() => spinner({ ...variantProps }), [objectToDeps(variantProps)]);
  const baseStyles2 = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useDataScrollOverflow2(props = {}) {
  ...
  const visibleRef = (0, import_react166.useRef)(visibility);
...
function useScrollShadow2(originalProps) {
  ...
  const styles = (0, import_react167.useMemo)(
    () => scrollShadow({
      ...variantProps,
      className
    }),
...
var Select = forwardRef(function Select2(props, ref) {
  ...
  const clonedIcon = (0, import_react169.cloneElement)(selectorIcon, getSelectorIconProps());
  const clearButton = (0, import_react168.useMemo)(() => {
    var _a2;
  ...
  const end = (0, import_react168.useMemo)(() => {
    if (clearButton) {
  ...
  const helperWrapper = (0, import_react168.useMemo)(() => {
  ...
  const renderSelectedItem = (0, import_react168.useMemo)(() => {
    var _a2;
