...
} from "./chunk-36PNYMRW.js";
import {
  TRANSITION_VARIANTS
} from "./chunk-VOWNM36W.js";
import {
...
import {
  button_default
} from "./chunk-GI45LEE2.js";
import "./chunk-TKPUP32E.js";
import "./chunk-I6YY6ZWF.js";
import {
  useAriaButton
...
function usePopover(originalProps) {
  ...
  const domTriggerRef = (0, import_react2.useRef)(null);
  const wasTriggerPressedRef = (0, import_react2.useRef)(false);
  ...
  const placement = (0, import_react2.useMemo)(() => {
    if (!ariaPlacement) {
      return null;
    }
  ...
  const onPress = (0, import_react2.useCallback)(
    (e) => {
      var _a2;
      let pressTimer;
  ...
  const getBackdropProps = (0, import_react2.useCallback)(
    (props2 = {}) => ({
      "data-slot": "backdrop",
...
var domAnimation = () => import("./dist-NLBFHL5S.js").then((res) => res.default);
...
var PopoverTrigger = (props) => {
  ...
  const child = (0, import_react4.useMemo)(() => {
    ...
    return import_react4.Children.only(children);
  }, [children]);
  const childRef = (_a = child.props.ref) != null ? _a : child.ref;
  const { onPress, isDisabled, ...restProps } = (0, import_react4.useMemo)(() => {
  ...
  const hasHeroUIButton = (0, import_react4.useMemo)(() => {
...
function useMenuItem(originalProps) {
  ...
  const getSelectedIconProps = (0, import_react6.useCallback)(
    (props2 = {}) => {
      return {
...
var MenuItem = (props) => {
  ...
  const selectedContent = (0, import_react7.useMemo)(() => {
...
function useDivider(props) {
  ...
  const getDividerProps = (0, import_react8.useCallback)(
    (props2 = {}) => ({
      className: styles,
      role: "separator",
...
var MenuSection = forwardRef(
  ({
    ...
    const slots = (0, import_react9.useMemo)(() => menuSection(), []);
    const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useMenu(props) {
  ...
  const slots = (0, import_react11.useMemo)(() => menu({ className }), [className]);
  const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function $a28c903ee9ad8dc5$export$79fefeb1c2091ac3(props) {
  ...
  let [focusStrategy, setFocusStrategy] = (0, import_react12.useState)(null);
  let [expandedKeysStack, setExpandedKeysStack] = (0, import_react12.useState)([]);
  let closeAll = () => {
...
var Dropdown = (props) => {
  ...
  const [menuTrigger, menu2] = import_react15.default.Children.toArray(children);
