...
import {
  ...
  useAriaOverlay
} from "./chunk-YBMI2HOS.js";
import {
  TRANSITION_VARIANTS
} from "./chunk-ENJOND75.js";
...
import {
  button_default
} from "./chunk-U7J2JI3K.js";
import "./chunk-G3YCLBHX.js";
import "./chunk-XPJ5IGSI.js";
import {
  useAriaButton
} from "./chunk-Z3BGZ7BB.js";
import {
...
var domAnimation = () => import("./dist-TO3WXAIQ.js").then((res) => res.default);
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
  ...
  let scrollPos = (0, import_react11.useRef)({
    top: 0,
    left: 0
  });
  ...
  let shouldVirtualFocusFirst = (0, import_react11.useRef)(false);
  ...
  const autoFocusRef = (0, import_react11.useRef)(autoFocus);
  const didAutoFocusRef = (0, import_react11.useRef)(false);
  ...
  let lastFocusedKey = (0, import_react11.useRef)(manager.focusedKey);
  let raf = (0, import_react11.useRef)(null);
  (0, import_react11.useEffect)(() => {
...
function $982254629710d113$export$b95089534ab7c1fd(props) {
  ...
  let delegate = (0, import_react13.useMemo)(() => keyboardDelegate || new (0, $2a25aae57d74318e$export$a05409b8bb224a5a)({
    collection,
    disabledKeys,
    disabledBehavior,
    ref,
...
function $a2e5df62f93c7633$export$9d32628fc2aea7da(props, state, ref) {
  ...
  let isPressedRef = (0, import_react14.useRef)(false);
  ...
  let interaction = (0, import_react14.useRef)(null);
  let onPressUp = (e) => {
...
function useMenuItem(originalProps) {
  ...
  const getSelectedIconProps = (0, import_react17.useCallback)(
    (props2 = {}) => {
      return {
...
var MenuItem = (props) => {
  ...
  const selectedContent = (0, import_react18.useMemo)(() => {
...
function useDivider(props) {
  ...
  const getDividerProps = (0, import_react19.useCallback)(
    (props2 = {}) => ({
      className: styles,
      role: "separator",
...
var MenuSection = forwardRef(
  ({
    ...
    const slots = (0, import_react20.useMemo)(() => menuSection(), []);
    const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function $875d6693e12af071$export$728d6ba534403756(props) {
  ...
  let disabledKeys = (0, import_react21.useMemo)(() => props.disabledKeys ? new Set(props.disabledKeys) : /* @__PURE__ */ new Set(), [
    props.disabledKeys
  ]);
  let tree = (0, $7613b1592d41b092$export$6cd28814d92fa9c9)(props, (0, import_react21.useCallback)((nodes) => new (0, $05ca4cd7c4a5a999$export$863faf230ee2118a)(nodes, {
    expandedKeys
  }), [
    expandedKeys
  ]), null);
...
function useMenu(props) {
  ...
  const slots = (0, import_react22.useMemo)(() => menu({ className }), [className]);
  const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
  ...
  const content = (0, import_jsx_runtime9.jsxs)(Component, { ...getListProps(), children: [
    ...
    [...state.collection].map((item) => {
      ...
      if (item.type === "section") {
        return (0, import_jsx_runtime9.jsx)(menu_section_default, { ...itemProps, itemClasses: mergedItemClasses }, item.key);
      }
      let menuItem2 = (0, import_jsx_runtime9.jsx)(menu_item_default, { ...itemProps, classNames: mergedItemClasses }, item.key);
      if (item.wrapper) {
...
function $a28c903ee9ad8dc5$export$79fefeb1c2091ac3(props) {
  ...
  let [expandedKeysStack, setExpandedKeysStack] = (0, import_react23.useState)([]);
  let closeAll = () => {
...
var Dropdown = (props) => {
  ...
  const [menuTrigger, menu2] = import_react26.default.Children.toArray(children);
