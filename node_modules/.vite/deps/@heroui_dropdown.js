...
import {
  button_default
} from "./chunk-TU6LBDAH.js";
import "./chunk-SNML52IF.js";
import "./chunk-EQUS4QIZ.js";
import {
  $40df3f8667284809$export$d55e7ee900f34e93,
  $fc909762b330b746$export$61c6a8c84e605fb6,
  useAriaOverlay
} from "./chunk-7U5FL3OP.js";
import {
  useMeasure
...
// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-7N5ZXA6H.mjs
...
// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-HGFRVVZK.mjs
...
// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-YK32CXJV.mjs
var React = __toESM(require_react(), 1);

// node_modules/@heroui/framer-utils/dist/chunk-54L3M2TC.mjs
var import_react7 = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var ResizablePanel = (0, import_react7.forwardRef)(
  (originalProps, ref) => {
...
var domAnimation2 = () => import("./dist-TO3WXAIQ.js").then((res) => res.default);
var FreeSoloPopoverWrapper = forwardRef(
  ({
    ...
    return disableAnimation ? (0, import_jsx_runtime2.jsx)("div", { ...otherProps, ref, children }) : (0, import_jsx_runtime2.jsx)(LazyMotion, { features: domAnimation2, children: (0, import_jsx_runtime2.jsx)(
      m.div,
      {
        ref,
        animate: "enter",
...
var FreeSoloPopover = forwardRef(
  ({ children, transformOrigin, disableDialogFocus = false, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime2.jsxs)($337b884510726a0d$export$c6fdb837b070b4ff, { portalContainer, children: [
      !isNonModal && backdropContent,
      (0, import_jsx_runtime2.jsx)(Component, { ...getPopoverProps(), children: (0, import_jsx_runtime2.jsxs)(
        FreeSoloPopoverWrapper,
        {
          ...
          ...dialogProps,
          children: [
            !isNonModal && (0, import_jsx_runtime2.jsx)($86ea4cb521eb2e37$export$2317d149ed6f78c4, { onDismiss: state.close }),
            (0, import_jsx_runtime2.jsx)("div", { ...getContentProps(), children: typeof children === "function" ? children(titleProps) : children }),
            (0, import_jsx_runtime2.jsx)($86ea4cb521eb2e37$export$2317d149ed6f78c4, { onDismiss: state.close })
          ]
        }
      ) })
    ] });
...
// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-CGIRYUEE.mjs
var [PopoverProvider, usePopoverContext] = createContext2({
  name: "PopoverContext",
  errorMessage: "usePopoverContext: `context` is undefined. Seems you forgot to wrap all popover components within `<Popover />`"
});

// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-Z57F4COC.mjs
var import_react8 = __toESM(require_react(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var domAnimation3 = () => import("./dist-TO3WXAIQ.js").then((res) => res.default);
var PopoverContent = (props) => {
  ...
  const content = children && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    !isNonModal && (0, import_jsx_runtime3.jsx)($86ea4cb521eb2e37$export$2317d149ed6f78c4, { onDismiss: onClose }),
    (0, import_jsx_runtime3.jsx)(Component, { ...dialogProps, children: (0, import_jsx_runtime3.jsx)("div", { ...getContentProps({ className }), children: typeof children === "function" ? children(titleProps) : children }) }),
    (0, import_jsx_runtime3.jsx)($86ea4cb521eb2e37$export$2317d149ed6f78c4, { onDismiss: onClose })
  ] });
  const backdropContent = (0, import_react8.useMemo)(() => {
    if (backdrop === "transparent") {
      return null;
    }
    if (disableAnimation) {
      return (0, import_jsx_runtime3.jsx)("div", { ...getBackdropProps() });
    }
    return (0, import_jsx_runtime3.jsx)(LazyMotion, { features: domAnimation3, children: (0, import_jsx_runtime3.jsx)(
      m.div,
      {
        animate: "enter",
        exit: "exit",
  ...
  const contents = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: disableAnimation ? content : (0, import_jsx_runtime3.jsx)(LazyMotion, { features: domAnimation3, children: (0, import_jsx_runtime3.jsx)(
    m.div,
    {
      animate: "enter",
      exit: "exit",
  ...
  return (0, import_jsx_runtime3.jsxs)("div", { ...getPopoverProps(), children: [
    backdropContent,
    contents
  ] });
};
...
// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-6FXDB7ZT.mjs
...
var PopoverTrigger = (props) => {
  ...
  const child = (0, import_react9.useMemo)(() => {
    if (typeof children === "string") return (0, import_jsx_runtime4.jsx)("p", { children });
    return import_react9.Children.only(children);
  }, [children]);
  const childRef = (_a = child.props.ref) != null ? _a : child.ref;
  const { onPress, isDisabled, ...restProps } = (0, import_react9.useMemo)(() => {
  ...
  const hasHeroUIButton = (0, import_react9.useMemo)(() => {
...
// node_modules/@heroui/dropdown/node_modules/@heroui/popover/dist/chunk-QWTMPRXH.mjs
var import_react10 = __toESM(require_react(), 1);
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
var Popover = forwardRef((props, ref) => {
  const { children, ...otherProps } = props;
  const context = usePopover({ ...otherProps, ref });
  const [trigger, content] = import_react10.Children.toArray(children);
  const overlay = (0, import_jsx_runtime5.jsx)($337b884510726a0d$export$c6fdb837b070b4ff, { portalContainer: context.portalContainer, children: content });
  return (0, import_jsx_runtime5.jsxs)(PopoverProvider, { value: context, children: [
    trigger,
    context.disableAnimation && context.isOpen ? overlay : (0, import_jsx_runtime5.jsx)(AnimatePresence, { children: context.isOpen ? overlay : null })
  ] });
});
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
  ...
  let shouldVirtualFocusFirst = (0, import_react12.useRef)(false);
  ...
  const didAutoFocusRef = (0, import_react12.useRef)(false);
...
function $880e95eb8b93ba9a$export$ecf600387e221c37(options) {
  ...
  let modality = (0, import_react13.useRef)(null);
  let longPressEnabled = hasAction && allowsSelection;
  let longPressEnabledOnPressStart = (0, import_react13.useRef)(false);
  let hadPrimaryActionOnPressStart = (0, import_react13.useRef)(false);
...
function $982254629710d113$export$b95089534ab7c1fd(props) {
  ...
  let delegate = (0, import_react14.useMemo)(() => keyboardDelegate || new (0, $2a25aae57d74318e$export$a05409b8bb224a5a)({
    collection,
    disabledKeys,
    disabledBehavior,
    ref,
...
function $a2e5df62f93c7633$export$9d32628fc2aea7da(props, state, ref) {
  ...
  let isPressedRef = (0, import_react15.useRef)(false);
  ...
  let interaction = (0, import_react15.useRef)(null);
  let onPressUp = (e) => {
...
function useMenuItem(originalProps) {
  ...
  const handlePress = (0, import_react18.useCallback)(
    (e) => {
  ...
  const getSelectedIconProps = (0, import_react18.useCallback)(
    (props2 = {}) => {
      return {
...
var MenuItem = (props) => {
  ...
  const selectedContent = (0, import_react19.useMemo)(() => {
    const defaultIcon = (0, import_jsx_runtime7.jsx)(MenuSelectedIcon, { disableAnimation, isSelected });
  ...
  return (0, import_jsx_runtime7.jsxs)(Component, { ...getItemProps(), children: [
    startContent,
    description ? (0, import_jsx_runtime7.jsxs)("div", { className: slots.wrapper({ class: classNames == null ? void 0 : classNames.wrapper }), children: [
      (0, import_jsx_runtime7.jsx)("span", { ...getLabelProps(), children: rendered }),
      (0, import_jsx_runtime7.jsx)("span", { ...getDescriptionProps(), children: description })
    ] }) : (0, import_jsx_runtime7.jsx)("span", { ...getLabelProps(), children: rendered }),
    shortcut && (0, import_jsx_runtime7.jsx)("kbd", { ...getKeyboardShortcutProps(), children: shortcut }),
    isSelectable && !hideSelectedIcon && (0, import_jsx_runtime7.jsx)("span", { ...getSelectedIconProps(), children: selectedContent }),
    endContent
  ] });
};
...
// node_modules/@heroui/menu/node_modules/@heroui/divider/dist/chunk-D2EG5U3Q.mjs
...
// node_modules/@heroui/menu/node_modules/@heroui/divider/dist/chunk-TS7K35D7.mjs
...
function useDivider(props) {
  ...
  const getDividerProps = (0, import_react20.useCallback)(
    (props2 = {}) => ({
      className: styles,
      role: "separator",
...
// node_modules/@heroui/menu/node_modules/@heroui/divider/dist/chunk-IHO36JMK.mjs
var import_jsx_runtime8 = __toESM(require_jsx_runtime(), 1);
var Divider = forwardRef((props, ref) => {
  const { Component, getDividerProps } = useDivider({ ...props });
  return (0, import_jsx_runtime8.jsx)(Component, { ref, ...getDividerProps() });
});
...
var MenuSection = forwardRef(
  ({
    ...
    const slots = (0, import_react21.useMemo)(() => menuSection(), []);
    const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
    ...
    return (0, import_jsx_runtime9.jsxs)(
      Component,
      {
        ...
        children: [
          item.rendered && (0, import_jsx_runtime9.jsx)(
            "span",
            {
              ...headingProps,
            ...
            "ul",
            {
              ...
              children: [
                [...item.childNodes].map((node) => {
                  ...
                  let menuItem2 = (0, import_jsx_runtime9.jsx)(
                    menu_item_default,
                    {
                ...
                showDivider && (0, import_jsx_runtime9.jsx)(
                  divider_default,
                  {
                    as: "li",
...
function $875d6693e12af071$export$728d6ba534403756(props) {
  ...
  let tree = (0, $7613b1592d41b092$export$6cd28814d92fa9c9)(props, (0, import_react22.useCallback)((nodes) => new (0, $05ca4cd7c4a5a999$export$863faf230ee2118a)(nodes, {
    expandedKeys
  }), [
    expandedKeys
  ]), null);
...
function useMenu(props) {
  ...
  const slots = (0, import_react23.useMemo)(() => menu({ className }), [className]);
  const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
  ...
  const content = (0, import_jsx_runtime10.jsxs)(Component, { ...getListProps(), children: [
    ...
    [...state.collection].map((item) => {
      ...
      if (item.type === "section") {
        return (0, import_jsx_runtime10.jsx)(menu_section_default, { ...itemProps, itemClasses: mergedItemClasses }, item.key);
      }
      let menuItem2 = (0, import_jsx_runtime10.jsx)(menu_item_default, { ...itemProps, classNames: mergedItemClasses }, item.key);
      if (item.wrapper) {
...
var DropdownMenu = forwardRef(function DropdownMenu2(props, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(popover_content_default, { children: (0, import_jsx_runtime11.jsx)($9bf71ea28793e738$export$20e40289641fbbb6, { contain: true, restoreFocus: true, children: (0, import_jsx_runtime11.jsx)(menu_default, { ...getMenuProps(props, ref) }) }) });
});
...
var DropdownTrigger = (props) => {
  ...
  const { children, ...otherProps } = props;
  return (0, import_jsx_runtime12.jsx)(popover_trigger_default, { ...getMenuTriggerProps(otherProps), children });
};
...
function $a28c903ee9ad8dc5$export$79fefeb1c2091ac3(props) {
  ...
  let [focusStrategy, setFocusStrategy] = (0, import_react24.useState)(null);
  let [expandedKeysStack, setExpandedKeysStack] = (0, import_react24.useState)([]);
  let closeAll = () => {
...
function useDropdown(props) {
  ...
  const styles = (0, import_react26.useMemo)(
    () => dropdown({
      className
    }),
    [className]
...
var Dropdown = (props) => {
  ...
  const [menuTrigger, menu2] = import_react27.default.Children.toArray(children);
  return (0, import_jsx_runtime13.jsx)(DropdownProvider, { value: context, children: (0, import_jsx_runtime13.jsxs)(popover_default, { ...context.getPopoverProps(), children: [
    menuTrigger,
    menu2
  ] }) });
};
...
//# sourceMappingURL=@heroui_dropdown.js.map
