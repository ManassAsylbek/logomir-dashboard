...
// node_modules/@heroui/modal/node_modules/@heroui/framer-utils/dist/chunk-54L3M2TC.mjs
...
// node_modules/@heroui/modal/node_modules/@heroui/framer-utils/dist/chunk-736YWA4T.mjs
...
var IsSSRContext = import_react3.default.createContext(false);
...
function useIsSSR() {
  if (typeof import_react3.default["useSyncExternalStore"] === "function") {
    return import_react3.default["useSyncExternalStore"](subscribe, getSnapshot, getServerSnapshot);
  }
  return (0, import_react3.useContext)(IsSSRContext);
}
function useViewportSize() {
  let isSSR = useIsSSR();
  let [size, setSize] = (0, import_react3.useState)(() => isSSR ? { width: 0, height: 0 } : getViewportSize());
...
var ModalContent = (props) => {
  ...
  const closeButtonContent = (0, import_react4.isValidElement)(closeButton) ? (0, import_react4.cloneElement)(closeButton, getCloseButtonProps()) : (0, import_jsx_runtime3.jsx)("button", { ...getCloseButtonProps(), children: (0, import_jsx_runtime3.jsx)(CloseIcon, {}) });
  ...
  const content = (0, import_jsx_runtime3.jsxs)(Component, { ...contentProps, onKeyDown: chain(contentProps.onKeyDown, onKeyDown), children: [
    (0, import_jsx_runtime3.jsx)($86ea4cb521eb2e37$export$2317d149ed6f78c4, { onDismiss: onClose }),
    !hideCloseButton && closeButtonContent,
    typeof children === "function" ? children(onClose) : children,
    (0, import_jsx_runtime3.jsx)($86ea4cb521eb2e37$export$2317d149ed6f78c4, { onDismiss: onClose })
  ] });
  const backdropContent = (0, import_react4.useMemo)(() => {
    ...
    return (0, import_jsx_runtime3.jsx)(LazyMotion, { features: domAnimation2, children: (0, import_jsx_runtime3.jsx)(
      m.div,
      {
        animate: "enter",
        exit: "exit",
  ...
  const contents = disableAnimation ? (0, import_jsx_runtime3.jsx)(
    "div",
    {
  ...
  ) : (0, import_jsx_runtime3.jsx)(LazyMotion, { features: domAnimation2, children: (0, import_jsx_runtime3.jsx)(
    m.div,
    {
      animate: "enter",
      className: slots.wrapper({ class: classNames == null ? void 0 : classNames.wrapper }),
  ...
  return (0, import_jsx_runtime3.jsxs)("div", { tabIndex: -1, children: [
    backdropContent,
    contents
  ] });
};
...
function useModal(originalProps) {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react7.useState)(false);
  ...
  const headerId = (0, import_react7.useId)();
  const bodyId = (0, import_react7.useId)();
  ...
  const getBackdropProps = (0, import_react7.useCallback)(
    (props2 = {}) => ({
...
var Modal = forwardRef((props, ref) => {
  ...
  const overlay = (0, import_jsx_runtime6.jsx)($337b884510726a0d$export$c6fdb837b070b4ff, { portalContainer: context.portalContainer, children });
  return (0, import_jsx_runtime6.jsx)(ModalProvider, { value: context, children: context.disableAnimation && context.isOpen ? overlay : (0, import_jsx_runtime6.jsx)(AnimatePresence, { children: context.isOpen ? overlay : null }) });
});
